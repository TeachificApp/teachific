      ...
      {!disabled && (
        <div className="sticky top-0 z-10 bg-white border-b border-gray-100 px-2 py-1.5 flex flex-wrap items-center gap-0.5 shadow-sm">
          ...
          <div className="relative">
            ...
            {emojiPickerOpen && (
              <div className="absolute bottom-full right-0 mb-1 z-50 shadow-xl rounded-xl overflow-hidden" style={{ minWidth: 320 }}>
                <Picker
                  data={data}
...
/** Alias for RichTextDisplay — used by pages that import { RichTextContent } */
