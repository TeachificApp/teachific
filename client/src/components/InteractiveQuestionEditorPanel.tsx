...
// ─── Re-export for hotspot and matching (from LessonQuizBlockEditor) ──────────
// These types are used in the extended editor panel below
export { HotspotEditor, MatchingEditor } from "@/components/LessonQuizBlockEditor";
export type { HotspotMarker, MatchingPair } from "@/components/LessonQuizBlockEditor";
