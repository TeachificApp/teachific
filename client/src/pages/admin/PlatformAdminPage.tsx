...
const SITEMAP_SECTIONS: SitemapSection[] = [
  ...
  },
  {
    ...
    entries: [
      { label: "Course360 Creator™ Dashboard", path: "/creator" },
      { label: "Course360 Creator™ Download (legacy)", path: "/creator/download" },
      { label: "Course360 Creator™ Pro (Marketing)", path: "/creator-pro" },
