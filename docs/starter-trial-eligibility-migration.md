...
The `org_subscriptions.starterTrialClaimed` field was added on **2026-09-24** to make Course360's 14-day Starter trial a one-time offer per organization. The application marks the field only after Stripe accepts a Starter trial Checkout session. It remains marked if Checkout is abandoned or a later subscription is cancelled, preventing repeat introductory trials.
