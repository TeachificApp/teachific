...
// Stub: enrollInFreeMembership is a no-op in Teachific (no Thinkific integration)
async function enrollInFreeMembership(_email: string, _firstName: string, _lastName: string) { /* no-op */ }
