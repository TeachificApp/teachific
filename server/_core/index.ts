...
// vite.ts is only imported dynamically in development to avoid bundling dev dependencies in production
...
async function startServer() {
  ...
  // Project-managed static assets use signed storage URLs.
