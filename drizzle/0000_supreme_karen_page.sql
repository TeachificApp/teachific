CREATE TABLE `accreditationChecklist` (
	...
	CONSTRAINT `accreditationChecklist_id` PRIMARY KEY(`id`)
);
...
CREATE TABLE `accreditationFormBranchRules` (
	...
	`targetType` varchar(20) NOT NULL DEFAULT 'item',
	...
	`conditions` longtext,
	`action` enum('show','hide','require','unrequire') NOT NULL DEFAULT 'show',
...
CREATE TABLE `accreditationFormItems` (
	...
	`label` text NOT NULL,
	`helpText` text,
	`itemType` enum('text','textarea','email','richtext','radio','checkbox','select','scale','heading','info','hidden') NOT NULL,
...
CREATE TABLE `accreditationFormSuccessModules` (
	...
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	`updatedAt` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `accreditationFormSuccessModules_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `accreditationFormSuccessRoutingRules` (
	...
	`grantAccessActions` longtext,
	`stripeEnabled` boolean NOT NULL DEFAULT false,
	`stripePriceId` varchar(255),
	`stripeAmount` int,
	`stripeCheckoutMode` varchar(20) DEFAULT 'payment',
	`stripeSuccessUrl` varchar(2000),
	`stripeCancelUrl` varchar(2000),
	`sortOrder` int NOT NULL DEFAULT 0,
	`isEnabled` boolean NOT NULL DEFAULT true,
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `accreditationFormSuccessRoutingRules_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
CREATE TABLE `accreditationFormTemplates` (
	...
	`isActive` boolean NOT NULL DEFAULT true,
	`hostDomain` varchar(255) DEFAULT 'app.allaboutultrasound.com',
	`themeSettings` longtext,
	`importedFromUrl` varchar(1000),
	`successMessage` longtext,
	`successRedirectUrl` varchar(500),
	`defaultSuccessModuleId` int,
	...
	`stripeAmount` int,
	`stripeCheckoutMode` varchar(20) DEFAULT 'payment',
	`stripeSuccessUrl` varchar(500),
	`stripeCancelUrl` varchar(500),
	`createdByUserId` int,
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	`updatedAt` timestamp NOT NULL DEFAULT (now()),
...
CREATE TABLE `bundle_enrollments` (
	...
	`user_id` int NOT NULL,
	`pricing_option_id` varchar(64),
	`stripe_payment_intent_id` varchar(128),
	`access_expires_at` timestamp,
	`enrolled_at` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `bundle_enrollments_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `bundle_items` (
	`id` int AUTO_INCREMENT NOT NULL,
	`bundle_id` int NOT NULL,
	`item_type` enum('course','quiz','download','product','webinar') NOT NULL,
...
CREATE TABLE `bundle_pricing_options` (
	...
	`sort_order` int NOT NULL DEFAULT 0,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `bundle_pricing_options_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE `cme_activity_forms` (
	`id` int AUTO_INCREMENT NOT NULL,
	`orgId` int NOT NULL,
	`courseId` int NOT NULL,
	`productType` varchar(32) NOT NULL DEFAULT 'lms_course',
	`activityTitle` varchar(512),
	`activityType` varchar(64),
	`proposedDate` varchar(128),
	`activityLengthHours` varchar(32),
	`cmeCreditsRequested` varchar(32),
	`offerMocCredit` varchar(32),
	`offeredMoreThanOnce` varchar(32),
	`activityStructure` varchar(64),
	`targetAudience` varchar(64),
	`estimatedLearners` varchar(64),
	`practiceGapDescription` text,
	`practiceGapReasons` text,
	`improvementTypes` text,
	`improvementKnowledgeText` text,
	`improvementCompetenceText` text,
	`improvementPerformanceText` text,
	`learnerOutcomes` text,
	`learningObjectives` text,
	`deliveryDescription` text,
	`activityIncludes` text,
	`assessmentMethods` text,
	`facultyJson` text,
	`contentStatus` varchar(64),
	`contentAvailableDate` varchar(128),
	`marketingChannels` text,
	`marketingMentionsCme` varchar(32),
	`registrationFee` varchar(32),
	`originalReleaseDate` varchar(64),
	`mostRecentReviewDate` varchar(64),
	`expirationDate` varchar(64),
	`attestationName` varchar(256),
	`attestationDate` varchar(64),
	`attestationTitle` varchar(256),
	`signatureDataUrl` longtext,
	`cmeStatus` varchar(32) NOT NULL DEFAULT 'draft',
	`approvedAt` bigint,
	`lastSentAt` bigint,
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	`updatedAt` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `cme_activity_forms_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `cme_send_history` (
	`id` int AUTO_INCREMENT NOT NULL,
	`orgId` int NOT NULL,
	`courseId` int NOT NULL,
	...
	`sentBy` varchar(255),
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `cme_send_history_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `communities` (
	...
	`logo_image` text,
	`status` enum('draft','published') NOT NULL DEFAULT 'draft',
	`privacy` enum('public','private','paid','invite_only','course_gated') NOT NULL DEFAULT 'public',
	`access_type` enum('free','paid','restricted','invite_only','course_gated','linked') NOT NULL DEFAULT 'free',
	`pricing_options` longtext,
	`landing_page_blocks` longtext,
	`page_blocks` longtext,
	`accent_color` varchar(32) DEFAULT '#189aa1',
	`sort_order` int NOT NULL DEFAULT 0,
	`icon_image` text,
	`linked_access_items` longtext,
	`banner_image` text,
	`welcome_message` text,
	`header_style` varchar(32) DEFAULT 'banner',
	`layout_style` varchar(32) DEFAULT 'sidebar',
...
--> statement-breakpoint
CREATE TABLE `community_course_linkages` (
	`id` int AUTO_INCREMENT NOT NULL,
	`community_id` int NOT NULL,
	`lms_course_id` int NOT NULL,
	`thinkific_course_id` varchar(64),
	`created_at` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `community_course_linkages_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE `community_workflow_rules` (
	`id` int AUTO_INCREMENT NOT NULL,
	`community_id` int NOT NULL,
	`name` varchar(200) NOT NULL,
	`trigger_type` enum('any_signup','any_purchase','course_enrollment','webinar_registration','download_purchase','bundle_purchase','brand_membership','membership_subscription') NOT NULL,
	`entity_id` int,
	`is_active` boolean NOT NULL DEFAULT true,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `community_workflow_rules_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE `curriculum_embed_visibility` (
	`id` int AUTO_INCREMENT NOT NULL,
	`course_id` int NOT NULL,
	`item_type` enum('section','lesson') NOT NULL,
	`item_id` int NOT NULL,
	`hidden` boolean NOT NULL DEFAULT true,
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `curriculum_embed_visibility_id` PRIMARY KEY(`id`),
	CONSTRAINT `uq_cev_course_item` UNIQUE(`course_id`,`item_type`,`item_id`)
);
--> statement-breakpoint
...
CREATE TABLE `digital_bundles` (
	...
	`status` enum('draft','published','hidden','private','archived') NOT NULL DEFAULT 'draft',
	`org_id` int,
	`after_purchase_workflow` longtext,
	`hide_pricing_options` boolean NOT NULL DEFAULT false,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `digital_products` (
	...
	`after_purchase_workflow` longtext,
	`member_page_blocks_above` longtext,
	`member_page_blocks_below` longtext,
	`hide_pricing_options` boolean NOT NULL DEFAULT false,
	`createdAt` timestamp DEFAULT (now()),
...
CREATE TABLE `diyOrganizations` (
	...
	`isShellOrg` boolean DEFAULT false,
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	`updatedAt` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `diyOrganizations_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `emailCampaignEvents` (
	`id` int AUTO_INCREMENT NOT NULL,
	...
	`city` varchar(100),
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `emailCampaignEvents_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE `emailSenderProfiles` (
	`id` int AUTO_INCREMENT NOT NULL,
	`name` varchar(200) NOT NULL,
	`email` varchar(300) NOT NULL,
	`replyTo` varchar(300),
	...
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	`updatedAt` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `emailSenderProfiles_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
CREATE TABLE `embed_widgets` (
	...
	`theme` enum('light','dark','brand') NOT NULL DEFAULT 'light',
	`card_style` enum('standard','compact','minimal') NOT NULL DEFAULT 'standard',
	`show_price` boolean NOT NULL DEFAULT true,
	`show_enroll_button` boolean NOT NULL DEFAULT true,
	`show_course_details` boolean NOT NULL DEFAULT false,
	`button_text` varchar(100) NOT NULL DEFAULT 'Enroll Now',
	...
	`created_at` timestamp NOT NULL DEFAULT (now()),
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `embed_widgets_id` PRIMARY KEY(`id`),
	CONSTRAINT `embed_widgets_token_unique` UNIQUE(`token`)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE `generalFormEmbedAnalytics` (
	`id` int AUTO_INCREMENT NOT NULL,
	`templateId` int NOT NULL,
	`widgetId` int,
	`eventType` varchar(40) NOT NULL,
	`triggerSource` varchar(80),
	`deviceType` varchar(20),
	`hostDomain` varchar(255),
	`sessionKey` varchar(64),
	`metadataJson` longtext,
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `generalFormEmbedAnalytics_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `generalFormEmbedWidgets` (
	`id` int AUTO_INCREMENT NOT NULL,
	`templateId` int NOT NULL,
	...
	`allowedDomains` longtext,
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	`updatedAt` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `generalFormEmbedWidgets_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE `general_form_progress_events` (
	`id` int AUTO_INCREMENT NOT NULL,
	...
	`event_type` enum('session_start','field_view','field_answer','page_advance','form_submit','form_abandon') NOT NULL,
	`created_at` bigint NOT NULL,
	CONSTRAINT `general_form_progress_events_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE `generalFormSuccessModules` (
	`id` int AUTO_INCREMENT NOT NULL,
	`templateId` int NOT NULL,
	`name` varchar(200) NOT NULL,
	`moduleType` enum('inline_message','full_page','redirect_url') NOT NULL,
	...
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	`updatedAt` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `generalFormSuccessModules_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `generalFormSuccessRoutingRules` (
	`id` int AUTO_INCREMENT NOT NULL,
	`templateId` int NOT NULL,
	`ruleLabel` varchar(255) DEFAULT '',
	`successModuleId` int NOT NULL,
	...
	`isEnabled` boolean NOT NULL DEFAULT true,
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `generalFormSuccessRoutingRules_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
CREATE TABLE `labSubscriptions` (
	...
	`notes` text,
	`accreditationTypes` text,
	`accreditationOnboardingComplete` boolean NOT NULL DEFAULT false,
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	`updatedAt` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `labSubscriptions_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `leadCaptureWidgets` (
	`id` int AUTO_INCREMENT NOT NULL,
	`name` varchar(255) NOT NULL,
	`headline` varchar(500) NOT NULL DEFAULT 'Stay in the loop',
	`subtext` varchar(1000),
	`emailPlaceholder` varchar(200) NOT NULL DEFAULT 'Enter your email',
	`namePlaceholder` varchar(200) DEFAULT 'Your name (optional)',
	`buttonText` varchar(200) NOT NULL DEFAULT 'Subscribe',
	`buttonColor` varchar(20) NOT NULL DEFAULT '#189aa1',
	`buttonTextColor` varchar(20) NOT NULL DEFAULT '#ffffff',
	`bgColor` varchar(20) NOT NULL DEFAULT '#f0fbfc',
	`textColor` varchar(20) NOT NULL DEFAULT '#0e1e2e',
	`borderRadius` int NOT NULL DEFAULT 8,
	`showNameField` boolean NOT NULL DEFAULT false,
	`listId` int,
	`embedCode` text,
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	`updatedAt` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `leadCaptureWidgets_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
CREATE TABLE `lms_courses` (
	...
	`certificate_title_override` varchar(512),
	...
	`completion_email_subject` varchar(512),
	`completion_email_body` longtext,
	`completion_redirect_url` varchar(1024),
	`welcome_email_enabled` boolean NOT NULL DEFAULT false,
	`welcome_email_subject` varchar(512),
	`welcome_email_body` longtext,
	`custom_thank_you_enabled` boolean NOT NULL DEFAULT false,
	`custom_thank_you_blocks` longtext,
	`post_purchase_redirect_url` varchar(1024),
	`waitlist_enabled` boolean NOT NULL DEFAULT false,
	`waitlist_heading` varchar(512),
	`waitlist_body` longtext,
	`waitlist_cta_label` varchar(255),
	`waitlist_cta_url` varchar(1024),
	`waitlist_redirect_url` varchar(1024),
	`waitlist_success_message` longtext,
	`upsell_enabled` boolean NOT NULL DEFAULT false,
	`upsell_headline` varchar(512),
	`upsell_description` longtext,
	`upsell_course_id` int,
	`upsell_product_id` int,
	`upsell_product_type` varchar(64),
	`hide_pricing_options` boolean NOT NULL DEFAULT false,
	`player_sidebar_blocks` longtext,
	`brand` varchar(128),
	`checkout_page_config` longtext,
	`purchase_terms_agreement` varchar(1024),
	`purchase_terms_link1_label` varchar(255),
	`purchase_terms_link1_url` varchar(1024),
	`purchase_terms_link2_label` varchar(255),
	`purchase_terms_link2_url` varchar(1024),
	`created_at` timestamp NOT NULL DEFAULT (now()),
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
...
--> statement-breakpoint
CREATE TABLE `lms_interests` (
	`id` int AUTO_INCREMENT NOT NULL,
	`name` varchar(100) NOT NULL,
	`slug` varchar(100) NOT NULL,
	`category` varchar(50) NOT NULL DEFAULT 'general',
	`brand_filter` varchar(20) NOT NULL DEFAULT 'both',
	`icon_emoji` varchar(10),
	`sort_order` int NOT NULL DEFAULT 0,
	`is_active` boolean NOT NULL DEFAULT true,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `lms_interests_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
CREATE TABLE `lms_lessons` (
	...
	`count_toward_completion` boolean NOT NULL DEFAULT true,
	`lesson_status` varchar(32) NOT NULL DEFAULT 'published',
	`show_video_controls` boolean NOT NULL DEFAULT true,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
...
--> statement-breakpoint
CREATE TABLE `lms_quiz_group_questions` (
	`id` int AUTO_INCREMENT NOT NULL,
	`group_id` int NOT NULL,
	`question_bank_id` int NOT NULL,
	`sort_order` int NOT NULL DEFAULT 0,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `lms_quiz_group_questions_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `lms_quiz_question_groups` (
	`id` int AUTO_INCREMENT NOT NULL,
	`quiz_id` int NOT NULL,
	`name` varchar(255) NOT NULL,
	`description` text,
	...
	`sort_order` int NOT NULL DEFAULT 0,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `lms_quiz_question_groups_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `lms_quiz_questions` (
	...
	`orgId` int NOT NULL,
	`quiz_id` int NOT NULL,
	`type` enum('multiple_choice','true_false','short_answer','matching','hotspot') NOT NULL DEFAULT 'multiple_choice',
	...
	`question_image_url` varchar(1024),
	`question_video_url` varchar(1024),
	`feedback_image_url` varchar(1024),
	`feedback_video_url` varchar(1024),
	`hotspot_markers` longtext,
	`matching_pairs` longtext,
	`created_at` timestamp NOT NULL DEFAULT (now()),
...
CREATE TABLE `lms_quizzes` (
	...
	`require_passing_to_progress` boolean NOT NULL DEFAULT false,
	`allow_retakes` boolean NOT NULL DEFAULT true,
	`show_correct_answers` boolean NOT NULL DEFAULT true,
	`show_per_question_result` boolean NOT NULL DEFAULT true,
	`show_only_percentage` boolean NOT NULL DEFAULT false,
	`use_question_groups` boolean NOT NULL DEFAULT false,
	`show_group_names` boolean NOT NULL DEFAULT false,
	`question_bank_folder_id` int,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `lms_video_events` (
	...
	`lesson_id` int NOT NULL,
	`course_id` int NOT NULL,
	`event_type` enum('play','pause','seek','complete','progress') NOT NULL,
...
CREATE TABLE `newsletter_subscribers` (
	...
	`interests` text,
	`source` varchar(100) NOT NULL DEFAULT 'subscribe_page',
...
CREATE TABLE `order_bumps` (
	...
	`sortOrder` int NOT NULL DEFAULT 0,
	`pricing_option_id` int,
	`bump_mode` enum('addon','upgrade') NOT NULL DEFAULT 'addon',
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	`updatedAt` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `org_links` (
	`id` int AUTO_INCREMENT NOT NULL,
	`primaryOrgId` int NOT NULL,
	`linkedOrgId` int NOT NULL,
	`initiatedByUserId` int NOT NULL,
	`acceptedByUserId` int,
	`inviteToken` varchar(128) NOT NULL,
	`inviteTokenExpiry` timestamp NOT NULL,
	`status` enum('pending','accepted','rejected','revoked') NOT NULL DEFAULT 'pending',
	`createdAt` timestamp NOT NULL DEFAULT (now()),
	`updatedAt` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `org_links_id` PRIMARY KEY(`id`),
	CONSTRAINT `org_links_inviteToken_unique` UNIQUE(`inviteToken`)
);
--> statement-breakpoint
...
CREATE TABLE `organizations` (
	...
	`printifyApiKey` text,
	`printfulApiKey` text,
	`bookvaultApiKey` text,
	`cmeEnabled` boolean NOT NULL DEFAULT false,
	`cmeOrgName` varchar(255),
	`cmeContactEmail` varchar(320),
...
CREATE TABLE `physical_product_orders` (
	...
	`notes` text,
	`bookvault_doc_ref` varchar(64),
	`bookvault_pod_ref` varchar(64),
	`bookvault_status` varchar(64),
	`bookvault_error` text,
	`bookvault_submitted_at` timestamp,
	`printify_order_id` varchar(64),
	`printify_status` varchar(64),
	`printify_submitted_at` timestamp,
	`printify_error` text,
	`printful_order_id` varchar(64),
	`printful_status` varchar(64),
...
CREATE TABLE `physical_products` (
	...
	`printify_product_id` varchar(128),
	`printify_variant_id` int,
	`printify_enabled` boolean NOT NULL DEFAULT false,
	`printful_store_id` int,
	`printful_sync_product_id` int,
	`printful_sync_variant_id` int,
	`printful_enabled` boolean NOT NULL DEFAULT false,
	`bookvault_enabled` boolean NOT NULL DEFAULT false,
	`bookvault_isbn` varchar(32),
	`meta_title` varchar(255),
	`meta_description` text,
	`meta_image` text,
	`created_at` timestamp NOT NULL DEFAULT (now()),
...
CREATE TABLE `printful_sync_products` (
	...
	`synced_variant_count` int NOT NULL DEFAULT 0,
	`is_ignored` boolean NOT NULL DEFAULT false,
	`retail_price` varchar(50),
	`currency` varchar(10) NOT NULL DEFAULT 'USD',
	`variants_json` longtext,
	`last_synced_at` timestamp,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `printful_sync_products_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
CREATE TABLE `product_addon_items` (
	...
	`created_at` timestamp NOT NULL DEFAULT (now()),
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `product_addon_items_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `question_bank` (
	`id` int AUTO_INCREMENT NOT NULL,
	`question` longtext NOT NULL,
	`type` enum('mcq','truefalse','multiselect','hotspot','matching') NOT NULL DEFAULT 'mcq',
	`options` longtext,
	...
	`hotspot_markers` text,
	`matching_pairs` text,
	`feedback_image_url` text,
	`feedback_video_url` text,
	`source_quiz_id` int,
	`source_quiz_question_id` int,
	`folder_id` int,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE `site_nav_menus` (
	...
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `site_nav_menus_id` PRIMARY KEY(`id`),
	CONSTRAINT `site_nav_menus_domain_key` UNIQUE(`domain`,`menu_key`)
);
--> statement-breakpoint
CREATE TABLE `site_pages` (
	...
	`editable_zones` longtext,
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `site_pages_id` PRIMARY KEY(`id`),
	CONSTRAINT `site_pages_domain_slug` UNIQUE(`domain`,`slug`)
);
--> statement-breakpoint
...
CREATE TABLE `user_active_org` (
	...
	`orgId` int NOT NULL,
	`updatedAt` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `user_active_org_userId` PRIMARY KEY(`userId`)
);
--> statement-breakpoint
...
CREATE TABLE `user_email_aliases` (
	...
	`email` varchar(255) NOT NULL,
	`label` varchar(100),
	`source` enum('admin_added','account_merge') NOT NULL DEFAULT 'admin_added',
	`created_at` timestamp NOT NULL DEFAULT (now()),
...
CREATE TABLE `user_login_events` (
	...
	`country` varchar(64),
	`created_at` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `user_login_events_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `user_page_view_events` (
	`id` int AUTO_INCREMENT NOT NULL,
	`user_id` int,
	...
	`duration_ms` int,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `user_page_view_events_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
CREATE TABLE `workshop_instances` (
	...
	`location_type` enum('in_person','virtual','hybrid') NOT NULL DEFAULT 'in_person',
	...
	`sales_close_date` timestamp,
	`sales_open_date` timestamp,
	`status` enum('draft','published','cancelled','completed') NOT NULL DEFAULT 'draft',
	`stripe_product_id` varchar(255),
	`instance_content` longtext,
	`landing_blocks` longtext,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `workshop_instances_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `workshop_pricing_options` (
	`id` int AUTO_INCREMENT NOT NULL,
	`workshop_id` int NOT NULL,
	`label` varchar(255) NOT NULL,
	`sublabel` varchar(500),
	`pricing_type` enum('one_time','free') NOT NULL DEFAULT 'one_time',
	`price` int NOT NULL DEFAULT 0,
	`compare_at_price` int,
	`stripe_price_id` varchar(255),
	`cta_label` varchar(100),
	...
	`is_active` boolean NOT NULL DEFAULT true,
	`created_at` timestamp NOT NULL DEFAULT (now()),
	CONSTRAINT `workshop_pricing_options_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
...
CREATE TABLE `workshop_resources` (
	...
	`created_at` timestamp NOT NULL DEFAULT (now()),
	`updated_at` timestamp NOT NULL DEFAULT (now()) ON UPDATE CURRENT_TIMESTAMP,
	CONSTRAINT `workshop_resources_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
CREATE TABLE `workshop_waitlist_entries` (
	`id` int AUTO_INCREMENT NOT NULL,
	`workshop_id` int NOT NULL,
	`name` varchar(255) NOT NULL,
	`email` varchar(255) NOT NULL,
	...
	`message` text,
	`created_at` bigint NOT NULL,
	CONSTRAINT `workshop_waitlist_entries_id` PRIMARY KEY(`id`)
);
--> statement-breakpoint
