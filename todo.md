...
- [x] Remove unreferenced legacy physician over-read invitation and completion email builders rather than retaining source-specific clinical notification defaults
- [x] Remove unreferenced legacy sonographer peer-review and accreditation meeting email builders rather than retaining source-specific clinical notification defaults
...
- [x] Remove unused legacy clinical navigation declarations from the shared Layout while retaining brand-aware navigation as the rendered source of truth
...
- [x] Resolve signed-in and guest course checkout success and cancellation URLs from the purchased course’s verified organization domain rather than caller-provided origins
- [x] Resolve embedded physical-product checkout return URLs from the purchased product’s verified organization domain rather than caller-provided origins
...
- [x] Add explicit affiliate-organization compatibility ownership for legacy affiliate records
...
- [x] Remove dormant source-branded public Meta Pixel selection and platform pixel APIs so organization surfaces cannot inherit source-project tracking defaults
...
- [x] Locate the active Site Pages manager and audit its rendered titles, headings, labels, and domain selection for source-brand variants
...
- [x] Replace remaining server-side form embed retired host fallbacks with course360.app while preserving saved form hostDomain values
...
- [x] Unregister the unreferenced legacy email-auth public router while retaining the supported Course360 custom-authentication flows
...
- [x] Rebrand active Stripe dispute administrator notifications and their platform dashboard fallback URLs to Course360 without changing payment or dispute handling
...
- [x] Quarantine the unreferenced base64 Media Repository upload procedure in favor of the secured chunked upload flow
- [x] Quarantine the unreferenced base64 Media Repository re-upload procedure in favor of the secured chunked replacement flow
...
- [x] Require organization-admin ownership and dollar-denominated inputs for mounted legacy LMS pricing reads and mutations
...
- [x] Add organization-scoped Question Bank folders and an optional folder selector for QuizMaker exports
- [x] Preserve supported question type, answers, media, and authored answer-order settings during export
- [x] Add regression coverage for cross-org Question Bank export rejection
- [x] Add regression coverage for exported question payload preservation
...
- [x] Split inventory: public web repos vs private Electron desktop apps (not Railway services)
- [x] Ignore iHeartEcho / echo-assist / echoassist — they are built into UltrasoundAssist (`ultrasound-app`)
- [x] Confirm `ultrasound-app` is the current UltrasoundAssist repo; skip old `ultrasound-assist`
...
- [ ] Port R2/OpenAI fallbacks into `ultrasound-app`
- [ ] Create one Railway project for `ultrasound-app` (UltrasoundAssist)
...
- [x] Apply the active organization theme to the remaining Webinar administration watch-time statistic accent
...
- [x] Require organization-admin ownership for legacy LMS certificate issuance and certificate-template administration
- [x] Require organization-admin ownership for legacy LMS category, group, membership, seat, enrollment, and invitation management
- [x] Require organization-admin ownership for legacy LMS discussion and assignment administration and user ownership for notes and bookmarks
...
- [x] Apply the active organization theme to Funnel Page Editor controls and authoring accents
...
- [x] Apply the active organization theme to Custom Pages administration controls
- [x] Resolve affiliate and instructor payout requests from the selected active organization
...
- [x] Apply the active organization theme to the funnel builder thank-you step
- [x] Review media file type badges and retain intentional semantic file-category colors
...
- [x] Resolve webinar checkout editing from the active organization context
- [x] Resolve Course Builder checkout editing from the active organization context
...
- [x] Apply the active organization theme to course waitlist navigation and actions
...
- [x] Apply the active organization theme to bundle administration controls
- [x] Apply the active organization theme to membership administration controls
- [x] Apply the active organization theme to physical product administration controls
- [x] Apply the active organization theme to product landing-page builder controls
...
- [x] Apply the active organization theme to email campaign block editor controls
...
- [x] Apply the active organization theme to general form builder controls
- [x] Apply the active organization theme to shared block template library controls
- [x] Apply the active organization theme to cohort resource administration controls
...
- [x] Apply the active organization theme to lesson comment controls
- [x] Apply the active organization theme to lesson audio block editor controls
...
- [x] Apply the active organization theme to LMS course-builder controls
...
- [x] Apply the active organization theme to LMS team administration controls
- [x] Apply the active organization theme to remaining LMS landing-page builder controls
- [x] Apply the active organization theme to LMS course question-bank authoring controls
- [x] Apply the active organization theme to LMS instructor and instructor-analytics administration controls
- [x] Apply the active organization theme to LMS affiliate, payout, and instructor-revenue controls
- [x] Apply the active organization theme to LMS order-management controls
- [x] Apply the active organization theme to LMS enrollment-export controls
- [x] Apply the active organization theme to LMS analytics dashboard controls
- [x] Apply the active organization theme to LMS administration navigation controls
- [x] Apply the active organization theme to LMS community administration controls
- [x] Apply the active organization theme to LMS free-preview enrollment controls
- [x] Apply the active organization theme to LMS instructor publish-request controls
...
- [x] Apply the active organization theme to LMS pricing-option editor controls
...
- [x] Apply the active organization theme to LMS cohort discussion controls
- [x] Apply the active organization theme to LMS cohort staff-dialog controls
- [x] Apply the active organization theme to LMS cohort waitlist settings controls
- [x] Apply the active organization theme to LMS lesson instructor override and effect controls
...
- [x] Validate all remaining persisted email-campaign resource audience IDs against the active organization (groups, forms, digital products/bundles, physical products, communities, and quizzes) and expose safe active-organization course/quiz/purchase audience controls in the Campaign composer.
